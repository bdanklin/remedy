defmodule Remedy.Consumer do
  ...
  @type guild_create ::
          {:GUILD_CREATE, new_guild :: Guild.t(), Websocket.t()}

  @type guild_available ::
          {:GUILD_AVAILABLE, new_guild :: Guild.t(), Websocket.t()}
  ...
  @type guild_member_remove ::
          {:GUILD_MEMBER_REMOVE, {guild_id :: integer, old_member :: Member.t()}, Websocket.t()}

  @type guild_member_update ::
          {:GUILD_MEMBER_UPDATE,
           {guild_id :: integer, old_member :: Member.t() | nil, new_member :: Member.t()},
           Websocket.t()}

  @type guild_role_create ::
          {:GUILD_ROLE_CREATE, Guild.Role.t(), Websocket.t()}

  @type guild_role_delete ::
          {:GUILD_ROLE_DELETE, Guild.Role.t(), Websocket.t()}

  @type guild_role_update ::
          {:GUILD_ROLE_UPDATE, Guild.Role.t(), Websocket.t()}
  ...
  @type user_update ::
          {:USER_UPDATE, {old_user :: User.t() | nil, new_user :: User.t()}, Websocket.t()}
