defmodule Remedy.Websocket.Events do
  @moduledoc false
      ...
      try do
        ...
        ArgumentError ->
          with pre_atoms = :erlang.system_info(:atom_count),
               ...
               post_atoms = :erlang.system_info(:atom_count) do
            if post_atoms > pre_atoms do
              new_atoms = post_atoms - pre_atoms

              atoms =
                for i <- pre_atoms..(post_atoms - 1) do
                  :erlang.binary_to_term(<<131, 75, i::24>>)
                end
